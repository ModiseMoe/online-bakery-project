...
<html>
    ...
    <section>
        <div class="container my-5">
            ...
            <form action="indexPageList" method="GET">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="bakeryProducts/<%=list.getImage()%>" class="card-img-top" style="aspect-ratio:1 / 1" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title"><%=list.getProduct_title()%></h5>
                                <h6 class="card-text">Price :R<%=decimalFormat.format(list.getProductPrice())%> </h6>
                                <div class="accordion">
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-content">
                                            ...
                                            <p class="card-text"><%=list.getProductWarnigs()%></p>
                                        </div>
                                    </div>
                                </div>

                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="AddToCart?product_id=<%=list.getId()%>" class="btn btn-dark shadow-0 me-1">Add to cart</a>
...
// Add click event listeners to each heading
    ...
    <script>
        var typingTimer;
        var doneTypingInterval = 5000; // milliseconds
