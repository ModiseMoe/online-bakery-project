...
<html>
    ...
    <section>
        <div class="container my-5">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent2">
                                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item acitve">
                                        <% List<Category> cat2 = (List<Category>) request.getAttribute("cat2"); %>
                                        <fieldset class="form-group">
                                            <div class="container mt-4">
                                                <div class="dropdown">
                                                    <form id="categoryForm" action="FllterByCat" method="GET">
                                                        <select name="catSelected" class="select" onchange="submitForm()">
                                                            <% for (Category li : cat2) {%>
                                                            <option value="<%=li.getId()%>"><%=li.getCategoryName()%></option>
                                                            <% }%>
                                                        </select>
                                                    </form>
                                                </div>
            ...
            <form action="FllterByCat" method="GET">
                <div class="row">
                    <%  List<Product> prod_cat = (List<Product>) request.getAttribute("prod-cat");
                    for (Product li : prod_cat) {%> 


                    <div class="col-lg-3 col-md-6 col-sm-6 d-flex">
                        <div class="card w-100 my-2 shadow-2-strong">
                            <img src="bakeryProducts/<%=li.getImage()%>" class="card-img-top" style="aspect-ratio: 1 / 1" />
                            <div class="card-body d-flex flex-column">
                                <h5 class="card-title"><%=li.getProduct_title()%></h5>
                                <h6 class="card-text">Price R<%=li.getProductPrice()%></h6>
                                <div class="accordion">
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-content">
                                            <p class="card-text"><%=li.getDescription()%></p>
                                            <p class="card-text"><%=li.getProductWarnigs()%></p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-footer d-flex align-items-end pt-3 px-0 pb-0 mt-auto">
                                    <a href="AddToCart?product_id=<%=li.getId()%>" class="btn btn-dark shadow-0 me-1">Add to cart</a>
