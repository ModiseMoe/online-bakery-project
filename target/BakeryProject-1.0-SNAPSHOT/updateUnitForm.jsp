<%-- 
    Document   : updateUnitForm
    Created on : Jun 7, 2023, 1:27:31 PM
    Author     : Train
--%>
...
<%
    ...
    Unit data = (Unit) request.getAttribute("data");
    ...
    <div class="contsiner col-md-5">
        <div class="card">
            <div class="card-body">
                ...
                <caption>Edit A Unit</caption>
                
                <fieldset class="form-group">
                    <label>Unit Name</label>
                    <input type="text" name="unit_name" value="<%=data.getUnit_name() %>" class="form-control">
                    <input type="hidden" name="unit_id" value="<%=data.getUnitId() %>" class="form-control">
                </fieldset>
