...
@WebServlet(name = "ProdMapID", urlPatterns = {"/ProdMapID"})
public class ProdMapID extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       request.setAttribute("prod", products);
        ...
        if(products != null){
           request.getRequestDispatcher("MapProdToCat").forward(request, response);
