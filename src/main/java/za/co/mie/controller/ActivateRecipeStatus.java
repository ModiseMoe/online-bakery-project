...
@WebServlet(name = "ActivateRecipeStatus", urlPatterns = {"/ActivateRecipeStatus"})
public class ActivateRecipeStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        retVal = bsci.activateRecipe(recipe_id);
