...
@WebServlet(name = "DisableUserStatus", urlPatterns = {"/DisableUserStatus"})
public class DisableUserStatus extends HttpServlet{
        ...
        retVal = bspi.disableUser(user_emailAdd);
