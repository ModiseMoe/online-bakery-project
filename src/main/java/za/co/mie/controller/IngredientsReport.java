...
@WebServlet(name = "IngredientsReport", urlPatterns = {"/IngredientsReport"})
public class IngredientsReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        document.open();
        document.addTitle("Ingredient Report");
        ...
        Paragraph heading = new Paragraph("All Ingredients Report", headingFont);
...
// Helper method to get the current date and time
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("allIngredientsReport.jsp").forward(request, response);
    }
