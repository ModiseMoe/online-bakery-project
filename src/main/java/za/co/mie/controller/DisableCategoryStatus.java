 ...
 * @author mdice
 */
@WebServlet(name = "DisableCategoryStatus", urlPatterns = {"/DisableCategoryStatus"})
public class DisableCategoryStatus extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       retVal =bsci.disableCategory(cat_id);
