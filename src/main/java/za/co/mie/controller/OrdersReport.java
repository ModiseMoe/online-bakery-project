...
@WebServlet(name = "OrdersReport", urlPatterns = {"/OrdersReport"})
public class OrdersReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Order> orderList = bsci.getAllOrders();
        ...
        Paragraph heading = new Paragraph("Orders Placed Report", headingFont);
...
// Helper method to get the current date and time
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("ordersReport.jsp").forward(request, response);
    }
