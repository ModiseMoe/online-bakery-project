<%-- 
    Document   : outstandingOrdersReport
    Created on : Jun 20, 2023, 2:28:27 PM
    Author     : Train
--%>
...
<html>
    ...
    <body>
        <div>    
            ...
            <form action="OutstandingOrdersReport" method="post">
            ...
            <table>
                ...
                <%
                    List<Order> orderList = (List<Order>) request.getAttribute("outstandingOrderList");
